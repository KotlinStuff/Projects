    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dbfGato.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                binding.tvNombre.text = getString(R.string.txtNombreGato, snapshot.child("nombre").value)
                binding.tvRaza.text = getString(R.string.txtRazaGato, snapshot.child("raza").value)
            }
        })
    }
